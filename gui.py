...
def studentFunction(ID, pw, root):
	...
	#Button to exit
	buttonImg = PhotoImage(file='design/ExitButtonImg.png')
	ButtonExit = Button(topWindow, image = buttonImg, command=lambda:deleteTwoWindows(topWindow, root))
	ButtonExit.image = buttonImg
	ButtonExit.place(x=600, y=485)
